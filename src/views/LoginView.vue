<template>
<div>
  <div style="width: 400px; height: 380px; margin: 150px auto; background-color:rgba(107,149,224,0.5); border-radius: 10px">
    <div style="width: 100%; height: 100px; font-size: 30px; line-height: 100px; text-align: center; color: #4a5ed0">欢迎登录高校就业管理系统</div>
    <div style="margin-top: 25px; text-align: center; height: 320px;">
      <el-form :model="form">
        ...
        <el-form-item>
          ...
          <el-button style="width: 80%; margin-top: 10px; margin-right:10px;" type="primary" @click="register()">注册</el-button>
        </el-form-item>
      </el-form>
