<template>
  <div>
    <div style="margin-bottom: 15px;">
      <el-input v-model="params.name" style="width: 200px; margin-right: 10px" placeholder="请输入公司名称">
      </el-input>
      <el-input v-model="params.industry" style="width: 200px; margin-right: 10px" placeholder="请输入所属行业">
      </el-input>
    ...
    <el-dialog title="请填写公司信息" :visible.sync="dialogFormVisible" width="30%" center>
      <el-form :model="form">
        ...
        <el-form-item v-if="role === ROLE_ADMIN" label="用户id" :label-width="formLabelWidth">
